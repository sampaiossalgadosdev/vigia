/**
 * Arquivo: contaPagar.routes.js
 * Responsabilidade: Definir os endpoints /api/contas-pagar e encadear
 * middlewares (auth, permissao do módulo "financeiro" — Fase 4a) e
 * controller. Nenhuma lógica aqui.
 */
const { Router } = require('express');
const controller = require('../controllers/contaPagar.controller');
const validator = require('../validators/contaPagar.validator');
